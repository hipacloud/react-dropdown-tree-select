  ...
  return (function(e) {
    ...
    function(e, t, n) {
              ...
              value: function() {
                ...
                return d(t)
                  ...
                  : t.map(function(e, t) {
                      ...
                      return c.a.createElement(
                        V,
                        K({ key: o }, r, e, { actionData: { action: K({}, e, { id: o }), nodeId: n } })
                      )
                    })
              },
            },
            ...
            Z(t, [
              {
                ...
                value: function() {
                  ...
                  return c.a.createElement(
                    'input',
                    G({ type: 'radio', name: t, ref: Q({ checked: n }), onChange: r, disabled: l }, i)
                  )
                },
              },
            ]),
        ...
        function t() {
          ...
          return (
            ...
            (r.handleCheckboxChange = function(e) {
              if ((console.log('handleCheckboxChange', e), 'input' !== e.target.nodeName.toLowerCase()))
                return e.preventDefault(), e.stopPropagation(), void e.nativeEvent.stopImmediatePropagation()
              var t = r.props,
                n = t.mode,
                o = t.id,
            ...
            (r.handleToggle = function(e) {
              if ((console.log('handleToggle ', e), r.props.isLeaf)) {
                var t = r.props,
                  n = t.id
                return (
                  (0, t.onCheckboxChange)(n, e.target.checked),
                  e.stopPropagation(),
                  void e.nativeEvent.stopImmediatePropagation()
                )
              }
              'input' === e.target.nodeName.toLowerCase()
                ...
                : (e.preventDefault(),
                  ...
                  r.props.onNodeToggle(r.props.id))
            }),
            re(r, n)
          )
        }
          ...
          ne(t, [
            {
              ...
              value: function() {
                ...
                var g = { id: o, value: s, checked: i, disabled: u, readOnly: h, tabIndex: -1 },
                  y = ['checkbox-item', 'simpleSelect' === t && 'simple-select'].filter(Boolean).join(' ')
                return c.a.createElement(
                  'span',
                  { title: n || r, onClick: this.handleToggle },
                  'radioSelect' === t
                    ? c.a.createElement(
                        ee,
                        te({ name: p, className: 'radio-item', onChange: this.handleCheckboxChange }, g)
                      )
                    : c.a.createElement(
                        J,
                        te({ name: o, className: y, indeterminate: d && a, onChange: this.handleCheckboxChange }, g)
                      ),
          ...
          ie(t, [
            {
              ...
              value: function() {
                ...
                if (this.props.toggler) {
                  var o = c.a.cloneElement(this.props.toggler)
                  return c.a.createElement(
                    'div',
                    { className: r },
                    c.a.createElement(o, { onClick: this.onToggle, onKeyDown: this.onKeyDown })
                  )
                }
            ...
            de(t, [
              {
                ...
                value: function() {
                  var e = this.props,
                    ...
                    S = n || !v ? { paddingLeft: 20 * (i || 0) + 'px' } : {},
                    C = r + '_li'
                  return c.a.createElement(
                    'li',
                    ue({ className: P, style: S, id: C }, u(a), this.getAriaAttributes()),
                    ...
                    c.a.createElement(ce, { isLeaf: pe(o), expanded: l, id: r, onNodeToggle: m, toggler: _ }),
                    c.a.createElement(H, { actions: y, onAction: b, id: r, readOnly: k })
                  )
                },
              },
            ]),
      ...
      var me = function() {
            ...
            (this.computeInstanceProps = function(t, n) {
              if (
                ...
                var r = t.activeDescendant.replace(/_li$/, ''),
                  o =
                    g(e.allVisibleNodes, function(e) {
                      return e.key === r
                    }) + 1
                ...
                n.forEach(function(n) {
                  e.shouldRenderNode(n, t) &&
                    b.push(
                      c.a.createElement(
                        ge,
                        ye({ keepTreeOnSearch: r, keepChildrenOnSearch: o, key: n._id }, n, {
                          searchModeOn: a,
                          onChange: d,
                          onCheckboxChange: h,
                          onNodeToggle: p,
        ...
        _e = function(e) {
          var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'children',
            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Te
          return (
            ke()(e[t], function(e) {
              return n(e).checked
            }) ||
      ...
      var Pe = function(e) {
        ...
        Ve = new Set([Be.FocusPrevious, Be.FocusNext, Be.FocusParent, Be.FocusFirst, Be.FocusLast]),
        Ke = [je, Ne, Re, Fe, Ae, Le],
        Ye = Ke.concat([Ie, De, Me]),
        qe = function(e, t, n, r) {
        ...
        He = function(e, t, n) {
          ...
          var r = t
          ;(function(e) {
            return qe(e, [Be.FocusFirst, Be.FocusLast], !0)
          })(n)
            ? (r = xe(e, 1)[0])
        ...
        Ue = {
          ...
          getNextFocus: function(e, t, n, r, o) {
            ...
            return (
              (function(e) {
                return qe(e, [Be.FocusPrevious, Be.FocusLast], !0)
              })(n) && (a = a.reverse()),
              He(a, t, n)
            )
          },
      ...
      n(9)
      n.d(t, 'clientIdGenerator', function() {
        return f
      }),
        n.d(t, 'Tree', function() {
          return we
        ...
        function t(e) {
          ...
          return (
            ...
            (n.onCheckboxChange = function(e, t, r) {
              ...
              ;((h && !p) || l) && Object.assign(y, n.resetSearchState()),
                h && !p && document.removeEventListener('click', n.handleOutsideClick, !1),
                We.adjustFocusedProps(f, g),
                n.setState(y, function() {
                  r && r(d)
                }),
                n.props.onChange(g, d)
            }),
            ...
            (n.getAriaAttributes = function() {
              var e = n.props,
                t = e.mode,
                r = e.texts
              return 'radioSelect' !== t ? {} : Je({ role: 'radiogroup' }, y(r.label))
            }),
              ...
              value: function() {
                ...
                return c.a.createElement(
                  ...
                  c.a.createElement(
                    ...
                    c.a.createElement(
                      M,
                      Je({ onTrigger: this.onTrigger, showDropdown: d }, f, { tags: p, tabIndex: l }),
                      c.a.createElement(x, Je({ tags: p, onTagRemove: this.onTagRemove }, f), !i && g)
                    ),
                    d &&
                      c.a.createElement(
                        'div',
